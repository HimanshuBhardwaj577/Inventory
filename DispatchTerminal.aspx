<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DispatchTerminal.aspx.cs" Inherits="Repair_Center.Dispatch" %>
...
<head runat="server">
    ...
    <title>Dispatch Terminal | Repair Center </title>
                        ...
                        <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                            <div class="widget-content widget-content-area br-6">
                                <div class="card shadow-sm">
                                    <div class="card-body">
                                        <br />
                                        <h4>Dispatch Terminal</h4>
                                        <hr />
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <asp:TextBox ID="TextBox1" Height="50px" class="form-control" autocomplete="off" placeholder="Received Awb Number" Font-Names="calabric" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <asp:TextBox ID="TextBox2" Height="50px" class="form-control" autocomplete="off" placeholder="Dispatch Courier Name" Font-Names="calabric" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <asp:TextBox ID="TextBox3" Height="50px" class="form-control" autocomplete="off" placeholder="Dispatch AWB Number" Font-Names="calabric" runat="server"></asp:TextBox>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <asp:TextBox ID="TextBox4" Height="50px" class="form-control" autocomplete="off" placeholder="Dispatch Date" Font-Names="calabric" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <asp:TextBox ID="TextBox5" Height="50px" class="form-control" autocomplete="off" placeholder="Terminal Remark" Font-Names="calabric" runat="server"></asp:TextBox>
                                            </div>
                                        </div>
                                        <hr />
                                        <div class="form-group">
                                            <asp:TextBox ID="TextBox6" Height="100px" class="form-control" autocomplete="off" placeholder="ETM Number" TextMode="MultiLine" Font-Names="calabric" runat="server"></asp:TextBox>
                                        </div>
                                        <br />
                                        <hr />
